                  ...
                  builder: (BuildContext context, AsyncSnapshot<FirebaseUser> snapshop){
                    switch(snapshop.connectionState){
                      ...
                      case ConnectionState.done:
                        print("datos de snap => ${snapshop.data.email} con conexion -> ${snapshop.connectionState}");

                        usuario = User(correo: snapshop.data.email ?? "",nombre: snapshop.data.displayName, photoUrl: snapshop.data.photoUrl ?? '');
